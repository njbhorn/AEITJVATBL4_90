package com.qa.tutorial.hibernate;
...
import com.qa.tutorial.hibernate.entities.Employee;
import com.qa.tutorial.hibernate.entities.Timekeeper;
...
public class MergeTransientDemo {
	...
	private static Timekeeper saveOrUpdate_Transient(Session session, Employee emp) {
		...
		// So there will be similarities between the two methods merge and
		// copyOrUpdate
