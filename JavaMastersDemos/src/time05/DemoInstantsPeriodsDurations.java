...
public class DemoInstantsPeriodsDurations {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println(zoneQA);
		
		LocalTime timeNY = LocalTime.now(zoneNY);
	    LocalTime timeQA = LocalTime.now(zoneQA);

	    System.out.println("Time in New York is " + timeNY);
	    System.out.println("Time in QA is " + timeQA);
