...
public class DemoEnumSet {
	...
	private enum Weekday {
		...
		public static final EnumSet<Weekday> WORKDAYS = EnumSet
														.range(MONDAY, FRIDAY);
		...
		public static final EnumSet<Weekday> THE_WHOLE_WEEK = EnumSet
														.allOf(Weekday.class);
	}
	...
	public static final void main(final String... argumgents) {
		...
		System.out.println ( Weekday.WORKDAYS
							.containsAll(Weekday.THE_WHOLE_WEEK)
							? "Yes, unfortunately."
							: "Certainly not.");
